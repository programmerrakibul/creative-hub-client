const Heading = ({ h5 = "", h3 = "", align = "center" }) => {
  return (
    <>
      <div
        className={`space-y-4 font-semibold max-w-121.5 w-full mb-7 ${align === "center" ? "mx-auto text-center" : ""}`}
      >
        <h5
          className={`text-2xl flex items-center gap-3 py-0.5 ${align === "center" ? "justify-center" : ""}`}
        >
